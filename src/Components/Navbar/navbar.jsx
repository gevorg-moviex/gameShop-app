...
export default function Navbar() {
    ...
    return (
        <nav className="relative flex justify-center items-center">
            ...
            <ul className={`flex-col items-center justify-center gap-8 fixed w-full top-28 left-0 border-white border z-50 bg-black p-4 transition-all duration-300 ease-in-out ${isOpen ? 'flex' : 'hidden'} md:flex md:flex-row md:static md:border-none md:bg-transparent`}>
                <li>
