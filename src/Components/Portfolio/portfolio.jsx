...
export default function Portfolio( {language} ) {
    return (
        ...
        <h1 className="text-4xl product660x:text-5xl font-bold text-white text-center product660x:text-left">{`${language ? "ԳՆՈՒՄՆԵՐ ԸՍՏ ԿԱՏԵԳՈՐԻԱՅԻ" : "SHOP BY CATEGORY"}`}</h1>
